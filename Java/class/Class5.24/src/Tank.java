...
//	private int category;
	...
	public void setLocation(int ax,int ay) { x = ax; y = ay;}
	...
	public void draw(Graphics g) {
		...
		if(flag == 0)
			g.drawImage(GameResource.getInstance().getImage(), x-17, y-17, x+17, y+17, imgX, 0, 34+imgX,34, null);
		else
			g.drawImage(GameResource.getInstance().getImage(), x-17, y-17, x+17, y+17, imgX+34, 0, 68+imgX,34, null);		
	}
	public Bullet fire() {
		int ax,ay;
		Bullet bullet=null;
